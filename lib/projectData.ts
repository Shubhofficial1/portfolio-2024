export const projectData = [
  {
    ...
    githubLink: "",
    deployedLink: "",
    primaryImage: "/images/project1.jpeg",
    lessons: [
      {
  ...
  },
  {
    ...
    githubLink: "",
    deployedLink: "",
    primaryImage: "/images/project2.jpeg",
    lessons: [
      {
        title: "Web Stack and Explanation 🔥",
        description:
  ...
  },
  {
    ...
    title: "Devshop ",
    description:
      "Experience A Faster And Sleeker (Devshop) Shopping Experience. Browse And Buy Products Directly From Your Phone, Anytime, Anywhere.",
    href: "/project/3",
    type: "Personal",
    techStack: ["React", "Tailwind", "MongoDb"],
    githubLink: "",
    deployedLink: "",
    primaryImage: "/images/project3.jpeg",
    lessons: [
      {
        title: "Web Stack and Explanation 🔥",
        description:
  ...
  },
  {
    ...
    githubLink: "",
    deployedLink: "",
    primaryImage: "/images/project4.jpeg",
    lessons: [
      {
        title: "Web Stack and Explanation 🔥",
        description:
